...
from .serializers import TraceabilityEventSerializer
...
def get_traceability_events(request, app_type, item_id):
    """
    Get all traceability events for a specific item.
    
    Args:
        app_type: The app type (parts, pcbas, assemblies, documents)
    ...
    serializer = TraceabilityEventSerializer(events, many=True)
